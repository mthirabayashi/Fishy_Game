	        ...
	        this.fish.forEach(function (el, idx) {
	          ...
	          if (Util.collision(el, _this2.hero[0])) {
	            ...
	            if (el.fish.width > _this2.hero[0].hero.width) {
	              ...
	              var lose = new createjs.Text("Game Over", "40px Arial", "#05B");
	              lose.x = 280;
	              lose.y = 200;
	              stage.addChild(lose);
	            ...
	            if (_this2.hero[0].hero.width > stage.canvas.width) {
	              createjs.Ticker.reset();
	              var win = new createjs.Text("You Won!", "40px Arial", "#05B");
	              win.x = 300;
	              win.y = 200;
	              stage.addChild(win);
	            ...
	            newFish = [].concat(_this2.fish.splice(0, idx).concat(_this2.fish.splice(1)));
	            _this2.fish = newFish;
	            _this2.hero[0].hero.scaleX += .025;
	            _this2.hero[0].hero.scaleY += .025;
	          }
