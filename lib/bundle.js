	  ...
	  _createClass(Game, [{
	    ...
	    value: function initialSound() {
	      if (this.mute === true) {
	        ...
	        console.log('sound initially muted');
	        this.backgroundNoise.pause();
	        console.log(this.backgroundNoise);
	      }
	    }
	  }, {
	    key: "updateScore",
	        ...
	        this.fish.forEach(function (el, idx) {
	          ...
	          if (Util.collision(el, _this3.hero[0])) {
	            ...
	            if (el.fish.width > _this3.hero[0].hero.width) {
	              ...
	              lose.y = 190;
	              stage.addChild(lose);
	              stage.removeChild(_this3.hero[0].hero);
	              stage.update();
	            ...
	            if (_this3.hero[0].hero.width > stage.canvas.width * .7) {
	              ...
	              _this3.fish.forEach(function (el) {
	                stage.removeChild(el.fish);
	              });
	              stage.update();
	              $('#replay').removeClass('hidden');
	              _this3.gameOver = true;
	              _this3.inputHighscore.bind(_this3)();
	              return;
	            }
	            stage.removeChild(el.fish);
	            newFish = [].concat(_this3.fish.splice(0, idx).concat(_this3.fish.splice(1)));
